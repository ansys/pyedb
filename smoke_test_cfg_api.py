...
# StackupConfig
from pyedb.configuration.cfg_api.stackup import LayerConfig, MaterialConfig, StackupConfig
...
m.add_padstack_definition(
    "via_full", hole_plating_thickness="25um", material="copper", hole_range="upper_pad_to_lower_pad"
)
