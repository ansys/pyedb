...
.. py:class:: Material(edb: pyedb.grpc.edb.Edb, core)
   ...
   .. py:property:: dc_model
      ...
      :class:`MultipoleDebyeModel <ansys.edb.core.definition.multipole_debye_model.MultipoleDebyeModel>` or
      float
          Dielectric model object or ``0.0`` when no model is assigned.
