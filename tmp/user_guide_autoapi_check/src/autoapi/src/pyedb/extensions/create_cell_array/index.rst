src.pyedb.extensions.create_cell_array
======================================

.. py:module:: src.pyedb.extensions.create_cell_array
...
.. autoapisummary::
   ...
   src.pyedb.extensions.create_cell_array.create_array_from_unit_cell


Module Contents
---------------

.. py:function:: create_array_from_unit_cell(edb: pyedb.Edb, x_number: int = 2, y_number: int = 2, offset_x: Optional[Union[int, float, str]] = None, offset_y: Optional[Union[int, float, str]] = None) -> bool
