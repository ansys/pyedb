src.pyedb.grpc.database.primitive.rectangle
===========================================

.. py:module:: src.pyedb.grpc.database.primitive.rectangle
...
.. autoapisummary::
   ...
   src.pyedb.grpc.database.primitive.rectangle.Rectangle


Module Contents
---------------

.. py:class:: Rectangle(pedb, core=None)
   ...
   .. py:property:: representation_type
      :type: str
   ...
   .. py:method:: create(layout, layer: Union[str, pyedb.grpc.database.layers.layer.Layer] = None, net: Union[str, pyedb.grpc.database.net.net.Net] = None, rep_type: str = 'center_width_height', param1: float = None, param2: float = None, param3: float = None, param4: float = None, corner_rad: float = 0.0, rotation: float = 0.0)
      :classmethod:
