src.pyedb.grpc.database.nets
============================

.. py:module:: src.pyedb.grpc.database.nets
...
.. autoapisummary::
   ...
   src.pyedb.grpc.database.nets.Nets
   src.pyedb.grpc.database.nets.NetClasses


Module Contents
---------------

.. py:class:: Nets(p_edb: Any)
...
.. py:class:: NetClasses(pedb)
   ...
   .. py:property:: items
      :type: Dict[str, pyedb.grpc.database.net.net_class.NetClass]
   ...
   .. py:method:: create(name, net) -> Union[bool, pyedb.grpc.database.net.net_class.NetClass]
