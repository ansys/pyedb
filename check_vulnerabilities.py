...
def check_vulnerabilities():
    ...
    if not REPOSITORY:
        raise RuntimeError("Required environment variable 'DEPENDENCY_CHECK_REPOSITORY' is not defined.")

    if not PACKAGE:
        raise RuntimeError("Required environment variable 'DEPENDENCY_CHECK_PACKAGE_NAME' is not defined.")
