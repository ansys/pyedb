...
from pyedb.edb_core.edb_data.utilities import EDBStatistics
...
class EdbLayout(object):
    ...
    def get_polygon_points(self, polygon):
        ...
        ----------
        polygon :
            class: `legacy.edb_core.edb_data.primitives_data.EDBPrimitives`
    ...
    def _create_path(
        ...
        Parameters
        ----------
        path_list : :class:`legacy.edb_core.layout.Shape`
            List of points.
        layer_name : str
    ...
    def create_polygon(self, main_shape, layer_name, voids=[], net_name=""):
        ...
        Returns
        -------
        bool, :class:`legacy.edb_core.edb_data.primitives.EDBPrimitives`
