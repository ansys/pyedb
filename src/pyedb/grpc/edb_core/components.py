...
class Components(object):
    ...
    def create_source_on_component(self, sources=None):
        ...
        for source in sources:
            ...
            if source.source_type == SourceType.Vsource:  # pragma: no cover
                ...
                negative_pin_group_term.boundary_type = terminal.BoundaryType.VOLTAGE_SOURCE
    ...
    def _create_pin_group_terminal(self, pingroup, isref=False):
        ...
        pingroup_term = terminal.PinGroupTerminal.create(
            layout=self._pedb.active_layout, net=pingroup.net, name=term_name, pin_group=pingroup, is_ref=isref
        )
