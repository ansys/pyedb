...
class Material(object):
    ...
    def _get_property(self, property_name):
        property_value = self._edb_material_def.get_property(property_name)
        if isinstance(property_value, utility.Value):
    ...
    def conductivity(self):
        self._conductivity = self._get_property(definition.MaterialProperty.CONDUCTIVITY)
        return self._conductivity

    @conductivity.setter
    def conductivity(self, value):
        """Retrieve material conductivity."""
        self._edb_material_def.property(definition.MaterialProperty.CONDUCTIVITY, utility.Value(value))
        self._conductivity = value

    @property
    def permittivity(self):
        """Retrieve material permittivity."""
        self._permittivity = self._get_property(definition.MaterialProperty.PERMITTIVITY)
        return self._permittivity

    @permittivity.setter
    def permittivity(self, value):
        self._edb_material_def.set_property(definition.MaterialProperty.PERMITTIVITY, value.Value(value))
        self._permittivity = value

    @property
    def permeability(self):
        """Retrieve material permeability."""
        material_id = definition.MaterialProperty.PERMEABILITY
        self._permeability = self._get_property(material_id)
        return self._permeability

    @permeability.setter
    def permeability(self, value):
        self._edb_material_def.set_property(definition.MaterialProperty.PERMEABILITY, utility.Value(value))
        self._permeability = value

    @property
    def loss_tangent(self):
        """Retrieve material loss tangent."""
        self._loss_tangent = self._get_property(definition.MaterialProperty.DIELECTRIC_LOSS_TANGENT)
        return self._loss_tangent

    @loss_tangent.setter
    def loss_tangent(self, value):
        self._edb_material_def.set_property(definition.MaterialProperty.DIELECTRIC_LOSS_TANGENT, utility.Value(value))
        self._loss_tangent = value

    @property
    def dc_conductivity(self):
        """"""
        if not self._edb_material_def.dielectric_material_model.is_null:
    ...
    def dc_conductivity(self, value):
        if not self._edb_material_def.dielectric_material_model.is_null:
            self._edb_material_def.dielectric_material_model.dc_conductivity = utility.Value(value)
    ...
    def dc_permittivity(self, value):
        if not self._edb_material_def.dielectric_material_model.is_null:
            self._edb_material_def.dielectric_material_model.dc_relative_permitivity = utility.Value(value)
    ...
    def dielectric_model_frequency(self, value):
        if not self._edb_material_def.dielectric_material_model.is_null:
            self._edb_material_def.dielectric_material_model.frequency = utility.Value(value)
    ...
    def loss_tangent_at_frequency(self, value):
        if not self._edb_material_def.dielectric_material_model.is_null:
            self._edb_material_def.dielectric_material_model.loss_tangent_at_frequency = utility.Value(value)
    ...
    def permittivity_at_frequency(self, value):
        if not self._edb_material_def.dielectric_material_model.is_null:
            self._edb_material_def.dielectric_material_model.relative_permitivity_at_frequency = utility.Value(value)

    @property
    def magnetic_loss_tangent(self):
        """Retrieve material magnetic loss tangent."""
        self._magnetic_loss_tangent = self._get_property(definition.MaterialProperty.MAGNETIC_LOSS_TANGENT)
        return self._magnetic_loss_tangent

    @magnetic_loss_tangent.setter
    def magnetic_loss_tangent(self, value):
        self._edb_material_def.set_property(definition.MaterialProperty.MAGNETIC_LOSS_TANGENT, utility.Value(value))
        self._magnetic_loss_tangent = value

    @property
    def thermal_conductivity(self):
        """Retrieve material thermal conductivity."""
        self._thermal_conductivity = self._get_property(definition.MaterialProperty.THERMAL_CONDUCTIVITY)
        return self._thermal_conductivity

    @thermal_conductivity.setter
    def thermal_conductivity(self, value):
        self._edb_material_def.set_property(definition.MaterialProperty.THERMAL_CONDUCTIVITY, utility.Value(value))
        self._thermal_conductivity = value

    @property
    def mass_density(self):
        """Retrieve material mass density."""
        self._mass_density = self._get_property(definition.MaterialProperty.MASS_DENSITY)
        return self._mass_density

    @mass_density.setter
    def mass_density(self, value):
        self._edb_material_def.set_property(definition.MaterialProperty.MASS_DENSITY, utility.Value(value))
        self._mass_density = value

    @property
    def youngs_modulus(self):
        """Retrieve material Young's Modulus."""
        self._youngs_modulus = self._get_property(definition.MaterialProperty.YOUNGS_MODULUS)
        return self._youngs_modulus

    @youngs_modulus.setter
    def youngs_modulus(self, value):
        self._edb_material_def.set_property(definition.MaterialProperty.YOUNGS_MODULUS, utility.Value(value))
        self._youngs_modulus = value

    @property
    def specific_heat(self):
        """Retrieve material Specific Heat."""
        material_id = definition.MaterialProperty.SPECIFIC_HEAT
        self._specific_heat = self._get_property(material_id)
        return self._specific_heat

    @specific_heat.setter
    def specific_heat(self, value):
        self._edb_material_def.set_property(definition.MaterialProperty.SPECIFIC_HEAT, utility.Value(value))
        self._specific_heat = value

    @property
    def poisson_ratio(self):
        """Retrieve material Poisson Ratio."""
        self._poisson_ratio = self._get_property(definition.MaterialProperty.POISSONS_RATIO)
        return self._poisson_ratio

    @poisson_ratio.setter
    def poisson_ratio(self, value):
        self._edb_material_def.set_property(definition.MaterialProperty.POISSONS_RATIO, utility.Value(value))
    ...
    def _load(self, input_dict):
        if input_dict:
            ...
            if input_dict["dielectric_model_frequency"] is not None:
                ...
                if self._edb_material_def.dielectric_material_model:
                    self._edb_material_def.dielectric_material_model = utility.Value(None)
...
class Materials(object):
    ...
    def add_material(
        ...
        if not name in self.materials:
            definition.MaterialDef.create(self._db, name)
    ...
    def add_djordjevicsarkar_material(
        ...
        :class:`pyaedt.edb_core.materials.Material`
            Material definition.
        """
        material_def = definition.DjordjecvicSarkarModel()
        material_def.frequency = test_frequency
        material_def.loss_tangent_at_frequency = utility.Value(loss_tangent)
    ...
    def add_multipole_debye_material(
        ...
        material_def = definition.MultipoleDebyeModel()
    ...
    def _add_dielectric_material_model(self, name, material_model):
        if definition.MaterialDef.find_by_name(self._db, name).is_null:
            definition.MaterialDef.create(self._db, name)
        material_def = definition.MaterialDef.find_by_name(self._db, name)
        if material_def:
    ...
    def duplicate(self, material_name, new_material_name):
        ...
        if material_name.lower() in material_list and new_material_name not in self.materials:
            ...
            permittivity = utility.Value(self.materials[material_name].permittivity)
            permeability = utility.Value(self.materials[material_name].permeability)
            conductivity = utility.Value(self.materials[material_name].conductivity)
            dielectric_loss_tangent = utility.Value(self.materials[material_name].loss_tangent)
            magnetic_loss_tangent = utility.Value(self.materials[material_name].magnetic_loss_tangent)
            thermal_conductivity = utility.Value(self.materials[material_name].thermal_conductivity)
            thermal_expansion_coefficient = utility.Value(self.materials[material_name].thermal_expansion_coefficient)
            youngs_modulus = utility.Value(self.materials[material_name].youngs_modulus)
            poisson_ratio = utility.Value(self.materials[material_name].poisson_ratio)
            mass_density = utility.Value(self.materials[material_name].mass_density)
            material_model = self.materials[material_name]._edb_material_def.dielectric_material_model
            edb_material = definition.MaterialDef.create(self._db, new_material_name)
            edb_material.set_property(definition.MaterialProperty.PERMITTIVITY, permittivity)
            edb_material.set_property(definition.MaterialProperty.PERMEABILITY, permeability)
            ...
            edb_material.set_property(definition.MaterialProperty.MAGNETIC_LOSS_TANGENT, magnetic_loss_tangent)
    ...
    def material_name_to_id(self, property_name):
        ...
        """
        props = {
            "Permittivity": definition.MaterialProperty.PERMITTIVITY,
            "Permeability": definition.MaterialProperty.PERMEABILITY,
            "Conductivity": definition.MaterialProperty.CONDUCTIVITY,
            "DielectricLossTangent": definition.MaterialProperty.DIELECTRIC_LOSS_TANGENT,
            "MagneticLossTangent": definition.MaterialProperty.MAGNETIC_LOSS_TANGENT,
            "ThermalConductivity": definition.MaterialProperty.THERMAL_CONDUCTIVITY,
            "MassDensity": definition.MaterialProperty.MASS_DENSITY,
            "SpecificHeat": definition.MaterialProperty.SPECIFIC_HEAT,
            "YoungsModulus": definition.MaterialProperty.YOUNGS_MODULUS,
            "PoissonsRatio": definition.MaterialProperty.POISSONS_RATIO,
            "ThermalExpansionCoefficient": definition.MaterialProperty.THERMAL_EXPANSION_COEFFICIENT,
            "InvalidProperty": definition.MaterialProperty.INVALID_PROPERTY,
        }
        ...
        if found_el:
            ...
            return definition.MaterialProperty.INVALID_PROPERTY
    ...
    def get_property_by_material_name(self, property_name, material_name):
        ...
        """
        if definition.MaterialDef.find_by_name(self._pedb._db, material_name).is_null:
            self._pedb.logger.error("This material doesn't exists.")
        else:
            original_material = definition.MaterialDef.find_by_name(self._pedb._db, material_name)
