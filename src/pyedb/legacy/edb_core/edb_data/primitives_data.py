...
class EDBPrimitives(EDBPrimitivesMain):
    ...
    def subtract(self, primitives):
        ...
        Parameters
        ----------
        primitives : :class:`legacy.edb_core.edb_data.EDBPrimitives` or EDB PolygonData or EDB Primitive or list

        Returns
        -------
        List of :class:`legacy.edb_core.edb_data.EDBPrimitives`
        """
...
class EdbPath(EDBPrimitives, PathDotNet):
    ...
    def create_edge_port(
        ...
        Returns
        -------
            :class:`legacy.edb_core.edb_data.sources.ExcitationPorts`
