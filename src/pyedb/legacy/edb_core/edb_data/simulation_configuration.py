...
class SimulationConfiguration(object):
    ...
    >>> from legacy.generic.constants import SolverType
    ...
    >>> from legacy.generic.constants import CutoutSubdesignType
    ...
    >>> from legacy.generic.constants import SweepType
    ...
    >>> from legacy.generic.constants import RadiationBoxType
    ...
    >>> from legacy.generic.constants import BasisOrder
    ...
    def solver_type(self):  # pragma: no cover
        ...
        Returns
        -------
        :class:`legacy.generic.constants.SolverType`
