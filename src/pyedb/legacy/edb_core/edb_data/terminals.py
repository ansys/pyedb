...
class Terminal(Connectable):
    ...
    def get_padstack_terminal_reference_pin(self, gnd_net_name_preference=None):  # pragma : no cover
        ...
        Returns
        -------
        :class:`legacy.edb_core.edb_data.padstack_data.EDBPadstackInstance`
        """
...
class EdgeTerminal(Terminal):
    ...
    def couple_ports(self, port):
        ...
        Parameters
        ----------
        port : :class:`legacy.edb_core.ports.WavePort`, :class:`legacy.edb_core.ports.GapPort`, list, optional
            Ports to be added.

        Returns
        -------
        :class:`legacy.edb_core.ports.BundleWavePort`
