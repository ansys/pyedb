...
class HfssSimulationSetup(object):
    ...
    def frequency_sweeps(self):
        ...
        Returns
        -------
        List of :class:`legacy.edb_core.edb_data.hfss_simulation_setup_data.EdbFrequencySweep`
        """
        sweep_data_list = {}
    ...
    def mesh_operations(self):
        ...
        Returns
        -------
        List of :class:`legacy.edb_core.edb_data.hfss_simulation_setup_data.MeshOperation`
    ...
    def add_length_mesh_operation(
        ...
        Returns
        -------
        :class:`legacy.edb_core.edb_data.hfss_simulation_setup_data.LengthMeshOperation`
        """
        if not name:
