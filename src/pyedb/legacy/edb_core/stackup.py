...
from pyedb.edb_core.edb_data.layer_data import LayerEdbClass
from pyedb.edb_core.edb_data.layer_data import StackupLayerEdbClass
...
class Stackup(object):
    ...
    def dielectric_layers(self):
        ...
        Returns
        -------
        dict[str, :class:`legacy.edb_core.edb_data.layer_data.EDBLayer`]
    ...
    def _set_layout_stackup(self, layer_clone, operation, base_layer=None, method=1):
        ...
        Parameters
        ----------
        layer_clone : :class:`legacy.edb_core.EDB_Data.EDBLayer`
        operation : str
    ...
    def plot(
        ...
        if first_layer is None or first_layer not in layer_names:
            ...
            raise AttributeError("first_layer must be str or class `legacy.edb_core.edb_data.layer_data.LayerEdbClass`")
        if last_layer is None or last_layer not in layer_names:
            ...
            raise AttributeError("last_layer must be str or class `legacy.edb_core.edb_data.layer_data.LayerEdbClass`")
