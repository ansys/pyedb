...
— all of which must be created correctly, validated, and reproduced bit-for-bit
...
* Onboarding new team members requires deep familiarity with the PyEDB API
  before any productive work can start.
...
* Reproducing a past result — or auditing a simulation — requires tracing
  through scripts rather than diffing a compact data file.
