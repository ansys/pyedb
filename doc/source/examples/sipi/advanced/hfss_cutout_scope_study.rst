Compare HFSS cutout scope strategies
====================================
...
Use ``python examples/hfss_cutout_scope_study.py --help`` to see the required board-specific arguments. All component, net, and layer names are supplied on the command line, so no external profile or helper file is required.

Complete standalone source
--------------------------

.. literalinclude:: ../../../../../tests/system_examples/advanced/hfss_cutout_scope_study.py
   :language: python
   :linenos:
   :caption: hfss_cutout_scope_study.py
