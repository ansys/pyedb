Reduce PCIe Gen5 via-stub impact
================================
...
Use ``python examples/pcie_gen5_backdrill_optimization.py --help`` to see the required board-specific arguments. All component, net, and layer names are supplied on the command line, so no external profile or helper file is required.

Complete standalone source
--------------------------

.. literalinclude:: ../../../../../tests/system_examples/advanced/pcie_gen5_backdrill_optimization.py
   :language: python
   :linenos:
   :caption: pcie_gen5_backdrill_optimization.py
