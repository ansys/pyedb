...
Both .NET and gRPC interfaces are maintained during the Beta phase.
Once gRPC is officially released PyEDB is going to use it by default and .NET version is going to be set as legacy.
